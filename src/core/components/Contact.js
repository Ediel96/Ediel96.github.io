            ...
            <div className="col-12">
              ...
              <div className="contact-info d-flex justify-content-between align-items-center py-4 px-lg-5">
                  <div className="contact-info-item">
                    <h3 className="mb-3 text-white">Correo</h3>
                    <p><a href="mailto:hello@company.co">h.amiltone.diel@gmail.com</a></p>
                  </div>
  
                  <ul className="social-links">
                       {/* <li><a href="#" className="uil uil-dribbble" data-toggle="tooltip" data-placement="left" title="" data-original-title="Dribbble"></a></li>
                       <li><a href="#" className="uil uil-instagram" data-toggle="tooltip" data-placement="left" title="" data-original-title="Instagram"></a></li>
                       <li><a href="#" className="uil uil-youtube" data-toggle="tooltip" data-placement="left" title="" data-original-title="Youtube"></a></li> */}
                  </ul>
              </div>
            </div>
